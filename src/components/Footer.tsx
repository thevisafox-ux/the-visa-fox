    ...
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="grid gap-12 lg:grid-cols-[1.4fr_0.8fr_0.8fr_1fr]">
        ...
        <div>
          ...
          <div className="mt-5 space-y-3 text-sm text-slate-300"><Link to="/contact">Work Visa Guidance</Link><Link to="/contact">Tourist Visa</Link><Link to="/contact">Study Visa</Link><Link to="/contact">Documentation</Link></div>
        </div>
        <div>
      ...
      <div className="mt-14 flex flex-col gap-3 border-t border-white/10 pt-7 text-xs text-slate-400 sm:flex-row sm:items-center sm:justify-between"><p>© {new Date().getFullYear()} The Visa Fox. All rights reserved.</p><p>Visa decisions are subject to the relevant immigration authority.</p></div>
    </div>
  </footer>
);
