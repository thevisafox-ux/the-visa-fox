...
const Home: React.FC = () => {
  ...
  const countries = [
    ...
    { name: 'Ireland', flag: '/ireland-flag.png', emoji: '🇮🇪', visa: 'Student, Work, PR' },
    { name: 'Netherlands', flag: '/netherlands-flag.png', emoji: '🇳🇱', visa: 'Student, Work, PR' },
    { name: 'Sweden', flag: '/sweden-flag.png', emoji: '🇸🇪', visa: 'Student, Work, PR' },
    { name: 'Denmark', flag: '/denmark-flag.png', emoji: '🇩🇰', visa: 'Student, Work, PR' },
    { name: 'Norway', flag: '/norway-flag.png', emoji: '🇳🇴', visa: 'Student, Work, PR' },
    { name: 'Finland', flag: '/finland-flag.png', emoji: '🇫🇮', visa: 'Student, Work, PR' },
    { name: 'Switzerland', flag: '/switzerland-flag.png', emoji: '🇨🇭', visa: 'Student, Work, PR' },
    { name: 'Austria', flag: '/austria-flag.png', emoji: '🇦🇹', visa: 'Student, Work, PR' },
    { name: 'Belgium', flag: '/belgium-flag.png', emoji: '🇧🇪', visa: 'Student, Work, PR' },
    { name: 'France', flag: '/france-flag.png', emoji: '🇫🇷', visa: 'Student, Work, Tourist' },
    { name: 'Italy', flag: '/italy-flag.png', emoji: '🇮🇹', visa: 'Student, Work, Tourist' },
    { name: 'Spain', flag: '/spain-flag.png', emoji: '🇪🇸', visa: 'Student, Work, Tourist' },
    { name: 'Portugal', flag: '/portugal-flag.png', emoji: '🇵🇹', visa: 'Student, Work, PR' },
    { name: 'Singapore', flag: '/singapore-flag.png', emoji: '🇸🇬', visa: 'Student, Work, PR' },
    { name: 'Japan', flag: '/japan-flag.png', emoji: '🇯🇵', visa: 'Student, Work, Tourist' },
    { name: 'South Korea', flag: '/south-korea-flag.png', emoji: '🇰🇷', visa: 'Student, Work, Tourist' },
    { name: 'Malaysia', flag: '/malaysia-flag.png', emoji: '🇲🇾', visa: 'Student, Work, Tourist' },
    { name: 'UAE', flag: '/uae-flag.png', emoji: '🇦🇪', visa: 'Work, Tourist' },
    { name: 'Qatar', flag: '/qatar-flag.png', emoji: '🇶🇦', visa: 'Work, Tourist' },
    { name: 'Saudi Arabia', flag: '/saudi-arabia-flag.png', emoji: '🇸🇦', visa: 'Work, Tourist' },
    { name: 'Poland', flag: '/poland-flag.png', emoji: '🇵🇱', visa: 'Student, Work, PR' },
    { name: 'Czech Republic', flag: '/czech-republic-flag.png', emoji: '🇨🇿', visa: 'Student, Work, PR' },
    { name: 'Hungary', flag: '/hungary-flag.png', emoji: '🇭🇺', visa: 'Student, Work, PR' },
    { name: 'Slovakia', flag: '/slovakia-flag.png', emoji: '🇸🇰', visa: 'Student, Work, PR' },
    { name: 'Slovenia', flag: '/slovenia-flag.png', emoji: '🇸🇮', visa: 'Student, Work, PR' },
    { name: 'Estonia', flag: '/estonia-flag.png', emoji: '🇪🇪', visa: 'Student, Work, PR' },
    { name: 'Latvia', flag: '/latvia-flag.png', emoji: '🇱🇻', visa: 'Student, Work, PR' },
    { name: 'Lithuania', flag: '/lithuania-flag.png', emoji: '🇱🇹', visa: 'Student, Work, PR' },
  ];
