...
const SopGenerator: React.FC = () => {
  ...
  const countries = [
    // Alphabetically sorted list of all countries and territories
    { name: 'Afghanistan', flag: '/afghanistan-flag.png', emoji: '🇦🇫' },
    { name: 'Algeria', flag: '/algeria-flag.png', emoji: '🇩🇿' },
    { name: 'American Samoa', flag: '/american-samoa-flag.png', emoji: '🇦🇸' },
    { name: 'Angola', flag: '/angola-flag.png', emoji: '🇦🇴' },
    { name: 'Antarctica', flag: '/antarctica-flag.png', emoji: '🇦🇶' },
    { name: 'Antigua and Barbuda', flag: '/antigua-and-barbuda-flag.png', emoji: '🇦🇬' },
    { name: 'Argentina', flag: '/argentina-flag.png', emoji: '🇦🇷' },
    { name: 'Armenia', flag: '/armenia-flag.png', emoji: '🇦🇲' },
    { name: 'Aruba', flag: '/aruba-flag.png', emoji: '🇦🇼' },
    { name: 'Australia', flag: '/Australia-flag.png', emoji: '🇦🇺' },
    { name: 'Austria', flag: '/austria-flag.png', emoji: '🇦🇹' },
    { name: 'Azerbaijan', flag: '/azerbaijan-flag.png', emoji: '🇦🇿' },
    { name: 'Bahamas', flag: '/bahamas-flag.png', emoji: '🇧🇸' },
    { name: 'Bahrain', flag: '/bahrain-flag.png', emoji: '🇧🇭' },
    { name: 'Bangladesh', flag: '/bangladesh-flag.png', emoji: '🇧🇩' },
    { name: 'Barbados', flag: '/barbados-flag.png', emoji: '🇧🇧' },
    { name: 'Belgium', flag: '/belgium-flag.png', emoji: '🇧🇪' },
    { name: 'Belize', flag: '/belize-flag.png', emoji: '🇧🇿' },
    { name: 'Benin', flag: '/benin-flag.png', emoji: '🇧🇯' },
    { name: 'Bermuda', flag: '/bermuda-flag.png', emoji: '🇧🇲' },
    { name: 'Bhutan', flag: '/bhutan-flag.png', emoji: '🇧🇹' },
    { name: 'Bolivia', flag: '/bolivia-flag.png', emoji: '🇧🇴' },
    { name: 'Bouvet Island', flag: '/bouvet-island-flag.png', emoji: '🇧🇻' },
    { name: 'Botswana', flag: '/botswana-flag.png', emoji: '🇧🇼' },
    { name: 'Brazil', flag: '/brazil-flag.png', emoji: '🇧🇷' },
    { name: 'British Virgin Islands', flag: '/british-virgin-islands-flag.png', emoji: '🇻🇬' },
    { name: 'Bulgaria', flag: '/bulgaria-flag.png', emoji: '🇧🇬' },
    { name: 'Burkina Faso', flag: '/burkina-faso-flag.png', emoji: '🇧🇫' },
    { name: 'Burundi', flag: '/burundi-flag.png', emoji: '🇧🇮' },
    { name: 'Cambodia', flag: '/cambodia-flag.png', emoji: '🇰🇭' },
    { name: 'Cameroon', flag: '/cameroon-flag.png', emoji: '🇨🇲' },
    { name: 'Canada', flag: '/canada-flag.png', emoji: '🇨🇦' },
    { name: 'Cape Verde', flag: '/cape-verde-flag.png', emoji: '🇨🇻' },
    { name: 'Cayman Islands', flag: '/cayman-islands-flag.png', emoji: '🇰🇾' },
    { name: 'Central African Republic', flag: '/central-african-republic-flag.png', emoji: '🇨🇫' },
    { name: 'Chad', flag: '/chad-flag.png', emoji: '🇹🇩' },
    { name: 'Chile', flag: '/chile-flag.png', emoji: '🇨🇱' },
    { name: 'China', flag: '/china-flag.png', emoji: '🇨🇳' },
    { name: 'Colombia', flag: '/colombia-flag.png', emoji: '🇨🇴' },
    { name: 'Comoros', flag: '/comoros-flag.png', emoji: '🇰🇲' },
    { name: 'Cook Islands', flag: '/cook-islands-flag.png', emoji: '🇨🇰' },
    { name: 'Costa Rica', flag: '/costa-rica-flag.png', emoji: '🇨🇷' },
    { name: 'Croatia', flag: '/croatia-flag.png', emoji: '🇭🇷' },
    { name: 'Cuba', flag: '/cuba-flag.png', emoji: '🇨🇺' },
    { name: 'Curaçao', flag: '/curacao-flag.png', emoji: '🇨🇼' },
    { name: 'Cyprus', flag: '/cyprus-flag.png', emoji: '🇨🇾' },
    { name: 'Czech Republic', flag: '/czech-flag.png', emoji: '🇨🇿' },
    { name: 'Democratic Republic of the Congo', flag: '/democratic-republic-of-the-congo-flag.png', emoji: '🇨🇩' },
    { name: 'Denmark', flag: '/denmark-flag.png', emoji: '🇩🇰' },
    { name: 'Djibouti', flag: '/djibouti-flag.png', emoji: '🇩🇯' },
    { name: 'Dominica', flag: '/dominica-flag.png', emoji: '🇩🇲' },
    { name: 'Dominican Republic', flag: '/dominican-republic-flag.png', emoji: '🇩🇴' },
    { name: 'Easter Island', flag: '/easter-island-flag.png', emoji: '🇨🇱' },
    { name: 'Ecuador', flag: '/ecuador-flag.png', emoji: '🇪🇨' },
    { name: 'Egypt', flag: '/egypt-flag.png', emoji: '🇪🇬' },
    { name: 'El Salvador', flag: '/el-salvador-flag.png', emoji: '🇸🇻' },
    { name: 'Equatorial Guinea', flag: '/equatorial-guinea-flag.png', emoji: '🇬🇶' },
    { name: 'Eritrea', flag: '/eritrea-flag.png', emoji: '🇪🇷' },
    { name: 'Estonia', flag: '/estonia-flag.png', emoji: '🇪🇪' },
    { name: 'Eswatini', flag: '/eswatini-flag.png', emoji: '🇸🇿' },
    { name: 'Ethiopia', flag: '/ethiopia-flag.png', emoji: '🇪🇹' },
    { name: 'Falkland Islands', flag: '/falkland-islands-flag.png', emoji: '🇫🇰' },
    { name: 'Fiji', flag: '/fiji-flag.png', emoji: '🇫🇯' },
    { name: 'Finland', flag: '/finland-flag.png', emoji: '🇫🇮' },
    { name: 'France', flag: '/france-flag.png', emoji: '🇫🇷' },
    { name: 'French Guiana', flag: '/french-guiana-flag.png', emoji: '🇬🇫' },
    { name: 'French Polynesia', flag: '/french-polynesia-flag.png', emoji: '🇵🇫' },
    { name: 'French Southern and Antarctic Lands', flag: '/french-southern-and-antarctic-lands-flag.png', emoji: '🇹🇫' },
    { name: 'Gabon', flag: '/gabon-flag.png', emoji: '🇬🇦' },
    { name: 'Galápagos Islands', flag: '/galapagos-islands-flag.png', emoji: '🇪🇨' },
    { name: 'Gambia', flag: '/gambia-flag.png', emoji: '🇬🇲' },
    { name: 'Georgia', flag: '/georgia-flag.png', emoji: '🇬🇪' },
    { name: 'Germany', flag: '/Germany-flag.png', emoji: '🇩🇪' },
    { name: 'Ghana', flag: '/ghana-flag.png', emoji: '🇬🇭' },
    { name: 'Greece', flag: '/greece-flag.png', emoji: '🇬🇷' },
    { name: 'Greenland', flag: '/greenland-flag.png', emoji: '🇬🇱' },
    { name: 'Grenada', flag: '/grenada-flag.png', emoji: '🇬🇩' },
    { name: 'Guam', flag: '/guam-flag.png', emoji: '🇬🇺' },
    { name: 'Guatemala', flag: '/guatemala-flag.png', emoji: '🇬🇹' },
    { name: 'Guinea', flag: '/guinea-flag.png', emoji: '🇬🇳' },
    { name: 'Guinea-Bissau', flag: '/guinea-bissau-flag.png', emoji: '🇬🇼' },
    { name: 'Guyana', flag: '/guyana-flag.png', emoji: '🇬🇾' },
    { name: 'Haiti', flag: '/haiti-flag.png', emoji: '🇭🇹' },
    { name: 'Heard Island and McDonald Islands', flag: '/heard-island-and-mcdonald-islands-flag.png', emoji: '🇭🇲' },
    { name: 'Honduras', flag: '/honduras-flag.png', emoji: '🇭🇳' },
    { name: 'Hong Kong', flag: '/hong-kong-flag.png', emoji: '🇭🇰' },
    { name: 'Hungary', flag: '/hungary-flag.png', emoji: '🇭🇺' },
    { name: 'Iceland', flag: '/iceland-flag.png', emoji: '🇮🇸' },
    { name: 'India', flag: '/india-flag.png', emoji: '🇮🇳' },
    { name: 'Indonesia', flag: '/indonesia-flag.png', emoji: '🇮🇩' },
    { name: 'Iran', flag: '/iran-flag.png', emoji: '🇮🇷' },
    { name: 'Iraq', flag: '/iraq-flag.png', emoji: '🇮🇶' },
    { name: 'Ireland', flag: '/ireland-flag.png', emoji: '🇮🇪' },
    { name: 'Israel', flag: '/israel-flag.png', emoji: '🇮🇱' },
    { name: 'Italy', flag: '/italy-flag.png', emoji: '🇮🇹' },
    { name: 'Ivory Coast', flag: '/ivory-coast-flag.png', emoji: '🇨🇮' },
    { name: 'Jamaica', flag: '/jamaica-flag.png', emoji: '🇯🇲' },
    { name: 'Japan', flag: '/japan-flag.png', emoji: '🇯🇵' },
    { name: 'Jordan', flag: '/jordan-flag.png', emoji: '🇯🇴' },
    { name: 'Kazakhstan', flag: '/kazakhstan-flag.png', emoji: '🇰🇿' },
    { name: 'Kenya', flag: '/kenya-flag.png', emoji: '🇰🇪' },
    { name: 'Kiribati', flag: '/kiribati-flag.png', emoji: '🇰🇮' },
    { name: 'Kuwait', flag: '/kuwait-flag.png', emoji: '🇰🇼' },
    { name: 'Kyrgyzstan', flag: '/kyrgyzstan-flag.png', emoji: '🇰🇬' },
    { name: 'Laos', flag: '/laos-flag.png', emoji: '🇱🇦' },
    { name: 'Latvia', flag: '/latvia-flag.png', emoji: '🇱🇻' },
    { name: 'Lebanon', flag: '/lebanon-flag.png', emoji: '🇱🇧' },
    { name: 'Lesotho', flag: '/lesotho-flag.png', emoji: '🇱🇸' },
    { name: 'Liberia', flag: '/liberia-flag.png', emoji: '🇱🇷' },
    { name: 'Libya', flag: '/libya-flag.png', emoji: '🇱🇾' },
    { name: 'Lithuania', flag: '/lithuania-flag.png', emoji: '🇱🇹' },
    { name: 'Luxembourg', flag: '/luxembourg-flag.png', emoji: '🇱🇺' },
    { name: 'Madagascar', flag: '/madagascar-flag.png', emoji: '🇲🇬' },
    { name: 'Malawi', flag: '/malawi-flag.png', emoji: '🇲🇼' },
    { name: 'Malaysia', flag: '/malaysia-flag.png', emoji: '🇲🇾' },
    { name: 'Mali', flag: '/mali-flag.png', emoji: '🇲🇱' },
    { name: 'Malta', flag: '/malta-flag.png', emoji: '🇲🇹' },
    { name: 'Marshall Islands', flag: '/marshall-islands-flag.png', emoji: '🇲🇭' },
    { name: 'Mauritania', flag: '/mauritania-flag.png', emoji: '🇲🇷' },
    { name: 'Mauritius', flag: '/mauritius-flag.png', emoji: '🇲🇺' },
    { name: 'Mexico', flag: '/mexico-flag.png', emoji: '🇲🇽' },
    { name: 'Micronesia', flag: '/micronesia-flag.png', emoji: '🇫🇲' },
    { name: 'Mongolia', flag: '/mongolia-flag.png', emoji: '🇲🇳' },
    { name: 'Morocco', flag: '/morocco-flag.png', emoji: '🇲🇦' },
    { name: 'Mozambique', flag: '/mozambique-flag.png', emoji: '🇲🇿' },
    { name: 'Myanmar', flag: '/myanmar-flag.png', emoji: '🇲🇲' },
    { name: 'Namibia', flag: '/namibia-flag.png', emoji: '🇳🇦' },
    { name: 'Nauru', flag: '/nauru-flag.png', emoji: '🇳🇷' },
    { name: 'Nepal', flag: '/nepal-flag.png', emoji: '🇳🇵' },
    { name: 'Netherlands', flag: '/netherlands-flag.png', emoji: '🇳🇱' },
    { name: 'New Caledonia', flag: '/new-caledonia-flag.png', emoji: '🇳🇨' },
    { name: 'New Zealand', flag: '/New-Zealand-flag.png', emoji: '🇳🇿' },
    { name: 'Nicaragua', flag: '/nicaragua-flag.png', emoji: '🇳🇮' },
    { name: 'Niger', flag: '/niger-flag.png', emoji: '🇳🇪' },
    { name: 'Nigeria', flag: '/nigeria-flag.png', emoji: '🇳🇬' },
    { name: 'Niue', flag: '/niue-flag.png', emoji: '🇳🇺' },
    { name: 'Northern Mariana Islands', flag: '/northern-mariana-islands-flag.png', emoji: '🇲🇵' },
    { name: 'Norway', flag: '/norway-flag.png', emoji: '🇳🇴' },
    { name: 'Oman', flag: '/oman-flag.png', emoji: '🇴🇲' },
    { name: 'Palau', flag: '/palau-flag.png', emoji: '🇵🇼' },
    { name: 'Panama', flag: '/panama-flag.png', emoji: '🇵🇦' },
    { name: 'Papua New Guinea', flag: '/papua-new-guinea-flag.png', emoji: '🇵🇬' },
    { name: 'Paraguay', flag: '/paraguay-flag.png', emoji: '🇵🇾' },
    { name: 'Peru', flag: '/peru-flag.png', emoji: '🇵🇪' },
    { name: 'Philippines', flag: '/philippines-flag.png', emoji: '🇵🇭' },
    { name: 'Pitcairn Islands', flag: '/pitcairn-islands-flag.png', emoji: '🇵🇳' },
    { name: 'Poland', flag: '/poland-flag.png', emoji: '🇵🇱' },
    { name: 'Portugal', flag: '/portugal-flag.png', emoji: '🇵🇹' },
    { name: 'Puerto Rico', flag: '/puerto-rico-flag.png', emoji: '🇵🇷' },
    { name: 'Qatar', flag: '/qatar-flag.png', emoji: '🇶🇦' },
    { name: 'Republic of the Congo', flag: '/republic-of-the-congo-flag.png', emoji: '🇨🇬' },
    { name: 'Romania', flag: '/romania-flag.png', emoji: '🇷🇴' },
    { name: 'Russia', flag: '/russia-flag.png', emoji: '🇷🇺' },
    { name: 'Rwanda', flag: '/rwanda-flag.png', emoji: '🇷🇼' },
    { name: 'Saint Kitts and Nevis', flag: '/saint-kitts-and-nevis-flag.png', emoji: '🇰🇳' },
    { name: 'Saint Lucia', flag: '/saint-lucia-flag.png', emoji: '🇱🇨' },
    { name: 'Saint Vincent and the Grenadines', flag: '/saint-vincent-and-the-grenadines-flag.png', emoji: '🇻🇨' },
    { name: 'Samoa', flag: '/samoa-flag.png', emoji: '🇼🇸' },
    { name: 'São Tomé and Príncipe', flag: '/sao-tome-and-principe-flag.png', emoji: '🇸🇹' },
    { name: 'Saudi Arabia', flag: '/saudi-arabia-flag.png', emoji: '🇸🇦' },
    { name: 'Senegal', flag: '/senegal-flag.png', emoji: '🇸🇳' },
    { name: 'Seychelles', flag: '/seychelles-flag.png', emoji: '🇸🇨' },
    { name: 'Sierra Leone', flag: '/sierra-leone-flag.png', emoji: '🇸🇱' },
    { name: 'Singapore', flag: '/singapore-flag.png', emoji: '🇸🇬' },
    { name: 'Sint Maarten', flag: '/sint-maarten-flag.png', emoji: '🇸🇽' },
    { name: 'Slovakia', flag: '/slovakia-flag.png', emoji: '🇸🇰' },
    { name: 'Slovenia', flag: '/slovenia-flag.png', emoji: '🇸🇮' },
    { name: 'Solomon Islands', flag: '/solomon-islands-flag.png', emoji: '🇸🇧' },
    { name: 'Somalia', flag: '/somalia-flag.png', emoji: '🇸🇴' },
    { name: 'South Africa', flag: '/south-africa-flag.png', emoji: '🇿🇦' },
    { name: 'South Georgia and the South Sandwich Islands', flag: '/south-georgia-and-the-south-sandwich-islands-flag.png', emoji: '🇬🇸' },
    { name: 'South Korea', flag: '/south-korea-flag.png', emoji: '🇰🇷' },
    { name: 'South Sudan', flag: '/south-sudan-flag.png', emoji: '🇸🇸' },
    { name: 'Spain', flag: '/spain-flag.png', emoji: '🇪🇸' },
    { name: 'Sri Lanka', flag: '/sri-lanka-flag.png', emoji: '🇱🇰' },
    { name: 'Sudan', flag: '/sudan-flag.png', emoji: '🇸🇩' },
    { name: 'Suriname', flag: '/suriname-flag.png', emoji: '🇸🇷' },
    { name: 'Sweden', flag: '/sweden-flag.png', emoji: '🇸🇪' },
    { name: 'Switzerland', flag: '/switzerland-flag.png', emoji: '🇨🇭' },
    { name: 'Syria', flag: '/syria-flag.png', emoji: '🇸🇾' },
    { name: 'Taiwan', flag: '/taiwan-flag.png', emoji: '🇹🇼' },
    { name: 'Tajikistan', flag: '/tajikistan-flag.png', emoji: '🇹🇯' },
    { name: 'Tanzania', flag: '/tanzania-flag.png', emoji: '🇹🇿' },
    { name: 'Thailand', flag: '/thailand-flag.png', emoji: '🇹🇭' },
    { name: 'Togo', flag: '/togo-flag.png', emoji: '🇹🇬' },
    { name: 'Tokelau', flag: '/tokelau-flag.png', emoji: '🇹🇰' },
    { name: 'Tonga', flag: '/tonga-flag.png', emoji: '🇹🇴' },
    { name: 'Trinidad and Tobago', flag: '/trinidad-and-tobago-flag.png', emoji: '🇹🇹' },
    { name: 'Tunisia', flag: '/tunisia-flag.png', emoji: '🇹🇳' },
    { name: 'Turkey', flag: '/turkey-flag.png', emoji: '🇹🇷' },
    { name: 'Turkmenistan', flag: '/turkmenistan-flag.png', emoji: '🇹🇲' },
    { name: 'Tuvalu', flag: '/tuvalu-flag.png', emoji: '🇹🇻' },
    { name: 'UAE', flag: '/uae-flag.png', emoji: '🇦🇪' },
    { name: 'Uganda', flag: '/uganda-flag.png', emoji: '🇺🇬' },
    { name: 'UK', flag: '/UK-flag.png', emoji: '🇬🇧' },
    { name: 'Ukraine', flag: '/ukraine-flag.png', emoji: '🇺🇦' },
    { name: 'Uruguay', flag: '/uruguay-flag.png', emoji: '🇺🇾' },
    { name: 'USA', flag: '/USA-flag.png', emoji: '🇺🇸' },
    { name: 'US Virgin Islands', flag: '/us-virgin-islands-flag.png', emoji: '🇻🇮' },
    { name: 'Uzbekistan', flag: '/uzbekistan-flag.png', emoji: '🇺🇿' },
    { name: 'Vanuatu', flag: '/vanuatu-flag.png', emoji: '🇻🇺' },
    { name: 'Venezuela', flag: '/venezuela-flag.png', emoji: '🇻🇪' },
    { name: 'Vietnam', flag: '/vietnam-flag.png', emoji: '🇻🇳' },
    { name: 'Wallis and Futuna', flag: '/wallis-and-futuna-flag.png', emoji: '🇼🇫' },
    { name: 'Western Sahara', flag: '/western-sahara-flag.png', emoji: '🇪🇭' },
    { name: 'Yemen', flag: '/yemen-flag.png', emoji: '🇾🇪' },
    { name: 'Zambia', flag: '/zambia-flag.png', emoji: '🇿🇲' },
    { name: 'Zimbabwe', flag: '/zimbabwe-flag.png', emoji: '🇿🇼' }
  ];
