      ...
      <div className="container-custom relative z-10">
        <div className="section-padding">
              ...
              <div className="space-y-3 md:space-y-4">
                ...
                <div className="space-y-2 md:space-y-3">
                  <div className="flex items-start space-x-2 md:space-x-3 group">
                    ...
                    <span className="group-hover:text-saffron transition-colors text-xs md:text-sm">SCO 103, Phase 7, Mohali, Punjab</span>
                  </div>
                  <div className="flex items-center space-x-2 md:space-x-3 group">
                    <Mail className="w-4 h-4 md:w-5 md:h-5 text-saffron group-hover:scale-110 transition-transform duration-200 flex-shrink-0" />
                    <span className="group-hover:text-saffron transition-colors text-xs md:text-sm">info@thevisafox.com</span>
                  </div>
                  <div className="flex items-center space-x-2 md:space-x-3 group">
              ...
              <ul className="space-y-2 md:space-y-3">
                <li>
                  <a href="/" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    ...
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">Home</span>
                  </a>
                </li>
                <li>
                  <a href="/checklist" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">Visa Checklist</span>
                  </a>
                </li>
                <li>
                  <a href="/sop-generator" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">SOP Generator</span>
                  </a>
                </li>
                <li>
                  <a href="/blogs" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">Blogs</span>
                  </a>
                </li>
                <li>
                  <a href="/contact" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">Contact</span>
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <ul className="space-y-2 md:space-y-3">
                <li>
                  <a href="/sop-generator" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">Student Visa</span>
                  </a>
                </li>
                <li>
                  <a href="/checklist" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">Work Visa Guidance</span>
                  </a>
                </li>
                <li>
                  <a href="/contact" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">Tourist Visa</span>
                  </a>
                </li>
                <li>
                  <a href="/contact" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">Permanent Residency</span>
                  </a>
                </li>
                <li>
                  <a href="/sop-generator" className="text-gray-300 hover:text-saffron transition-all duration-200 flex items-center space-x-2 group">
                    <span className="w-1.5 h-1.5 bg-saffron rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-200"></span>
                    <span className="group-hover:translate-x-1 transition-transform duration-200 text-xs md:text-sm">SOP Writing</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div className="border-t border-white/20 mt-6 md:mt-8 pt-6 md:pt-8">
            <div className="flex flex-col lg:flex-row items-center justify-between space-y-3 md:space-y-4 lg:space-y-0">
              <p className="text-gray-300 text-xs md:text-sm">
                © {currentYear} The Visa Fox. All rights reserved.
              </p>
              <div className="flex flex-wrap items-center justify-center space-x-4 md:space-x-6 text-xs md:text-sm">
